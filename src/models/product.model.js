...
const productSchema = new mongoose.Schema({
    ...
    family: { type: mongoose.Schema.Types.ObjectId, ref: 'Family', default: null, index: true },
    subFamily: { type: mongoose.Schema.Types.ObjectId, ref: 'SubFamily', default: null, index: true },
